class Intcode:
    ...
    def send(self, value):
        try:
            ...
            if self.trace:
                print(f"{self.name} hit StopIteration")
            pass
    ...
    def __in(self, modes):
        self.memory[self.memory[self.iptr + 1]] = self.__input
        self.__input = None
        self.iptr += 2

    def __out(self, modes=None):
        self.__output = self.memory[self.memory[self.iptr + 1]]
        self.iptr += 2
    ...
    def __start(self):
        ...
        while self.memory[self.iptr] != 99:
            ...
            if self.trace:
                print(f"Processing instruction {self.iptr}")
            ...
            if opcode in self.instructions:
                ...
                # Wait until we have the required input
